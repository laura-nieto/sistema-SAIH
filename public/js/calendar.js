...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarEl, {
    ...
    dateClick: function dateClick(info) {
      ...
      var mes = info.date.getMonth() + 1 < 10 ? '0' + (info.date.getMonth() + 1) : info.date.getMonth() + 1,
          dia = info.date.getDate() < 10 ? '0' + info.date.getDate() : info.date.getDate();
      var fecha = info.date.getFullYear() + '-' + mes + '-' + dia,
  ...
  calendar.render(); // CREAR NUEVO EVENTO

  document.getElementById('btnGuardar').addEventListener('click', function (e) {
    e.preventDefault();
    var datos = new FormData(formulario);
    axios.post(baseURL + '/evento/agregar', datos).then(function (respuesta) {
      document.getElementById('evento').classList.toggle("hidden");
    })["catch"](function (error) {
      if (error.response) {
        console.log(error.response.data);
  ...
  document.getElementById('btnEditar').addEventListener('click', function (e) {
    ...
    axios.post(baseURL + '/evento/actualizar/' + formulario2.id.value, datos).then(function (respuesta) {
      document.getElementById('edit').classList.toggle("hidden");
    })["catch"](function (error) {
      if (error.response) {
        console.log(error.response.data);
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/calendar.js");
/******/ 	
/******/ })()
;
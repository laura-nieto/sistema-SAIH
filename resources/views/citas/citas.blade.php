                        ...
                        <form action="" id="formulario">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="apellido" id="apellido" placeholder="Ingrese un apellido"
                                    class="bg-white border border-gray-200 rounded shadow-sm @error('apellido')border-red-500 @enderror">
                                @error('apellido')
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="nombre" id="nombre" placeholder="Ingrese un nombre"
                                    class="bg-white border border-gray-200 rounded shadow-sm @error('nombre')border-red-500 @enderror">
                                @error('nombre')
                                    <span class="error text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="flex flex-col">
                                ...
                                <input type="date" name="start" id="start" placeholder="Ingrese un día"
                                    class="bg-white border border-gray-200 rounded shadow-sm @error('start')border-red-500 @enderror">
                                @error('start')
                                    <span class="error text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="time" name="hora_inicio" id="hora_inicio" placeholder="Ingrese la hora de inicio"
                                    class="bg-white border border-gray-200 rounded shadow-sm @error('hora_inicio')border-red-500 @enderror">
                                @error('hora_inicio')
                                    <span class="error text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="flex flex-col">
                                ...
                                <input type="time" name="hora_fin" id="hora_fin" placeholder="Ingrese la hora de fin"
                                    class="bg-white border border-gray-200 rounded shadow-sm @error('hora_fin')border-red-500 @enderror">
                                @error('hora_fin')
                                    <span class="error text-red-500">{{ $message }}</span>
                                @enderror
                            </div>

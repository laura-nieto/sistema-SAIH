    ...
    <div class="py-12 flex-1 p-10">
        ...
        <div>
            ...
            <form action="" method="post" id="reportar">
                @csrf
                <div class="bg-white text-black px-4 py-3" x-data="{ tipo_reporte , cuestionario , colaborador }" x-init="$watch('tipo_reporte', value => value == 1 ? cuestionario = 0 : colaborador = 0)">
                    <div class="flex flex-col md:flex-row md:items-end">
                        ...
                        <div class="flex flex-col mt-2 md:mt-auto md:mr-3" x-show="colaborador == 2 || cuestionario == 2" x-transition>
                        ...
                        {{-- SELECT DIAGNOSTICO --}}
                        <div class="flex flex-col mt-2 md:mt-auto md:mr-3" x-show="colaborador == 4" x-transition>
                            ...
                            <div
                                x-data="seleccion_buscador({ data: {{ $diagnosticos }}, emptyOptionsMessage: 'No hay diagnosticos con esa búsqueda.', name: 'diagnostico', placeholder: 'Seleccione un diagnostico', input:'input_diagnostico' })"
                                x-init="init()"
                                @click.away="closeListbox()"
                                @keydown.escape="closeListbox()"
                                class="relative w-80"
    ...
    @section('js')
        <script>
            ...
            btn_send.addEventListener('click',function(e){
                ...
                if (value == 1) {
                    form.action="/reportes/descargar/colaborador";
                    form.submit();
                }else if(value == 2){
                    form.action="/reportes/descargar/cuestionario";
                    form.submit();
                }else{

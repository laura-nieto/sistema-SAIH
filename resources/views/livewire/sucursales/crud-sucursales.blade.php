            ...
            <div class="overflow-hidden sm:px-6 lg:px-8">
                ...
                <table class="text-black min-w-full divide-y divide-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @if(!$sucursales->count())
                            <tr>
                                <td class="px-6 py-4 border-b-2" colspan="4">No existen sucursales</td>
                            </tr>
                        @else
                            @foreach($sucursales as $sucursal)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $sucursal->empresa->nombre }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-evenly">
                                            ...
                                            @can('admin.sucursales.destroy')
                                                @if($sucursal->deleted_at == null)                            
                                                    <button wire:click='abrirModalDelete({{$sucursal->id}})'

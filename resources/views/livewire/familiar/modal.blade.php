    ...
    <div class="flex justify-center lg:h-screen items-center bg-gray-200 bg-opacity-75 antialiased">
        <div
            ...
            <div
                ...
                <p class="font-semibold text-gray-800">Crear Familiar</p>
            ...
            <div class="flex flex-col px-6 py-5 bg-gray-50 overflow-y-auto h-90 lg:h-auto">
                <form action="" method="post" class="mb-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    <div class="flex flex-col">
                        ...
                        <select name="cliente_id" id="cliente_id" wire:model="cliente_id" {{$edit ? 'disabled' : ''}}
                    ...
                    @if ($edit)
                        <div class="flex flex-col">
                            ...
                            <select name="colaborador_id" id="colaborador_id" wire:model="colaborador_id" {{$edit ? 'disabled' : ''}}
                                class="w-full bg-white text-black border border-gray-200 rounded shadow-sm appearance-none">
                                <option selected value>Seleccione un colaborador</option>
                                <option value="{{$colaborador_id}}">
                                    {{$colaborador_nombre}}
                                </option>
                            </select>
                    ...
                    @endif
                    <div class="flex flex-col">
                        <label class="mb-2 mt-5 font-semibold text-gray-700" for="relacion">Relacion</label>
                        <select name="relacion" id="relacion" wire:model="relacion"
                            class="w-full bg-white text-black border border-gray-200 rounded shadow-sm appearance-none">
                            <option selected value>Seleccione una relación</option>

    ...
    <div class="flex justify-center h-screen items-center bg-gray-200 bg-opacity-75 antialiased">
        <div
            ...
            <div
                ...
                <p class="font-semibold text-gray-800">Crear Cuestionario</p>
                    ...
                    @foreach ($preguntas as $pregunta)
                        <div class="flex flex-col">
                            <label class="inline-flex items-center">
                                <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" wire:model="id_preguntas" value="{{$pregunta->id}}">
                                <span class="ml-2 text-gray-700">{{$pregunta->pregunta}}</span>
                            </label>
                        </div>
                    @endforeach
                </form>

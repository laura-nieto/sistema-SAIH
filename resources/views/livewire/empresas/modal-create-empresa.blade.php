                    ...
                    <div class="flex flex-col">
                        ...
                        @foreach ($sucursales as $sucursal)
                            <label class="inline-flex items-center mt-3">
                                <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" wire:model="sucursales_id" value="{{$sucursal->id}}">
                                <span class="ml-2 text-gray-700">{{$sucursal->nombre}}</span>
                            </label>
                        @endforeach
                        @error('sucursales_id')

    ...
    <div class="flex justify-center h-screen items-center bg-gray-200 bg-opacity-75 antialiased">
        <div
            ...
            <div
                ...
                <p class="font-semibold text-gray-800">Crear Especialidad Médica</p>
            ...
            <div class="flex flex-col px-6 py-5 bg-gray-50">
                <form action="" method="post" class="mb-3">
                    <div class="flex flex-col">
                        <label class="mb-2 mt-5 font-semibold text-gray-700" for="especialidad">Especialidad</label>
                        <input type="text" name="especialidad" id="especialidad" placeholder="Ingrese el nombre de la especialidad"
                            class="bg-white text-black border border-gray-200 rounded shadow-sm @error('especialidad')border-red-500 @enderror" wire:model="especialidad">
                        @error('especialidad')
                            <span class="error text-red-500">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="flex flex-col">
                        <label class="mb-2 mt-5 font-semibold text-gray-700" for="bitCat_lugar">Bit Cat Lugar</label>
                        <input type="number" name="bitCat_lugar" id="bitCat_lugar" placeholder="Ingrese "
                            class="bg-white text-black border border-gray-200 rounded shadow-sm @error('bitCat_lugar')border-red-500 @enderror" wire:model="bitCat_lugar">
                        @error('bitCat_lugar')
                            <span class="error text-red-500">{{$message}}</span>
                        @enderror
                    </div>         
